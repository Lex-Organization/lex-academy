...
### Expected Outcome
By the end of this lesson, the student should have: **Cached product pages with inventory-triggered revalidation**.

### Acceptance Criteria
- You can explain today's focus in your own words: Next.js caching mechanisms — request memoization, data cache, full route cache, and Incremental Static Regeneration.
- The expected outcome is present and reviewable: Cached product pages with inventory-triggered revalidation.
...
```text
I am stuck on today's focus: Next.js caching mechanisms — request memoization, data cache, full route cache, and Incremental Static Regeneration. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
