...
### Expected Outcome
By the end of this lesson, the student should have: **Cart reducer with ADD_ITEM, REMOVE_ITEM, UPDATE_QUANTITY, CLEAR_CART, APPLY_DISCOUNT actions**.

### Acceptance Criteria
- You can explain today's focus in your own words: useReducer for complex state management, typed action patterns, state machines, combining useReducer with Context.
- The expected outcome is present and reviewable: Cart reducer with ADD_ITEM, REMOVE_ITEM, UPDATE_QUANTITY, CLEAR_CART, APPLY_DISCOUNT actions.
...
```text
I am stuck on today's focus: useReducer for complex state management, typed action patterns, state machines, combining useReducer with Context. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
