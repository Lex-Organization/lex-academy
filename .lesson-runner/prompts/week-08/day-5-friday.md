...
### Expected Outcome
By the end of this lesson, the student should have: **Multi-page e-commerce app with product browsing, cart, theme, auth, and error handling**.

### Acceptance Criteria
- You can explain today's focus in your own words: Build day — combine all Module 8 patterns into a complete e-commerce storefront.
- The expected outcome is present and reviewable: Multi-page e-commerce app with product browsing, cart, theme, auth, and error handling.
...
```text
I am stuck on today's focus: Build day — combine all Module 8 patterns into a complete e-commerce storefront. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
