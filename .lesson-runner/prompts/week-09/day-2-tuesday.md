...
### Expected Outcome
By the end of this lesson, the student should have: **Multi-step checkout form (shipping, payment, review) using only React + Zod**.

### Acceptance Criteria
- You can explain today's focus in your own words: Native React form handling (controlled vs uncontrolled, FormData, React 19 form features) and Zod for schema-based validation — no external form libraries.
- The expected outcome is present and reviewable: Multi-step checkout form (shipping, payment, review) using only React + Zod.
...
```text
I am stuck on today's focus: Native React form handling (controlled vs uncontrolled, FormData, React 19 form features) and Zod for schema-based validation — no external form libraries. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
