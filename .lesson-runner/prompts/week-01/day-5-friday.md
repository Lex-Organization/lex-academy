...
### Expected Outcome
By the end of this lesson, the student should have: **Complete product data (12+ products), filter/sort/search functions, console output, and first HTML connections**.

### Acceptance Criteria
- You can explain today's focus in your own words: Build day -- connect JavaScript to the HTML page and build a working static catalog.
- The expected outcome is present and reviewable: Complete product data (12+ products), filter/sort/search functions, console output, and first HTML connections.
...
```text
I am stuck on today's focus: Build day -- connect JavaScript to the HTML page and build a working static catalog. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
