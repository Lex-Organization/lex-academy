...
### Expected Outcome
By the end of this lesson, the student should have: **No new code -- this is assessment and review**.

### Acceptance Criteria
- You can explain today's focus in your own words: Module 1 review, mock interview, and quiz.
- The expected outcome is present and reviewable: No new code -- this is assessment and review.
...
```text
I am stuck on today's focus: Module 1 review, mock interview, and quiz. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
