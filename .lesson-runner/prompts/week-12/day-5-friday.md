...
### Expected Outcome
By the end of this lesson, the student should have: **Authenticated embroidery store with real database persistence**.

### Acceptance Criteria
- You can explain today's focus in your own words: Integrate auth and database into the bookmarks app from Module 10.
- The expected outcome is present and reviewable: Authenticated embroidery store with real database persistence.
...
```text
I am stuck on today's focus: Integrate auth and database into the bookmarks app from Module 10. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
