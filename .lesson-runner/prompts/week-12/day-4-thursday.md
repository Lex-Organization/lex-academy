...
### Expected Outcome
By the end of this lesson, the student should have: **SEO-optimized pages with proper images, fonts, and metadata**.

### Acceptance Criteria
- You can explain today's focus in your own words: next/image, next/font, generateMetadata, and SEO optimization.
- The expected outcome is present and reviewable: SEO-optimized pages with proper images, fonts, and metadata.
...
```text
I am stuck on today's focus: next/image, next/font, generateMetadata, and SEO optimization. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
