...
### Expected Outcome
By the end of this lesson, the student should have: **Customer accounts: register, login, GitHub/Google OAuth for the embroidery store**.

### Acceptance Criteria
- You can explain today's focus in your own words: Auth.js (NextAuth.js v5) — OAuth providers, sessions, sign-in/sign-out, protected routes.
- The expected outcome is present and reviewable: Customer accounts: register, login, GitHub/Google OAuth for the embroidery store.
...
```text
I am stuck on today's focus: Auth.js (NextAuth.js v5) — OAuth providers, sessions, sign-in/sign-out, protected routes. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
