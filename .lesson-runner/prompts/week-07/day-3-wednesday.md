...
### Expected Outcome
By the end of this lesson, the student should have: **Optimize the embroidery store's product list rendering with 100+ products**.

### Acceptance Criteria
- You can explain today's focus in your own words: useMemo, useCallback, React.memo — understanding when and why to optimize rendering performance.
- The expected outcome is present and reviewable: Optimize the embroidery store's product list rendering with 100+ products.
...
```text
I am stuck on today's focus: useMemo, useCallback, React.memo — understanding when and why to optimize rendering performance. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
