...
### Expected Outcome
By the end of this lesson, the student should have: **Store with data fetching, debounced search, persistent cart, optimized rendering, and all custom hooks integrated**.

### Acceptance Criteria
- You can explain today's focus in your own words: Build day — combine all hooks into the enhanced embroidery storefront.
- The expected outcome is present and reviewable: Store with data fetching, debounced search, persistent cart, optimized rendering, and all custom hooks integrated.
...
```text
I am stuck on today's focus: Build day — combine all hooks into the enhanced embroidery storefront. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
