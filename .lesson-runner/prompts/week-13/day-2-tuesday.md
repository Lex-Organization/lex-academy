...
### Expected Outcome
By the end of this lesson, the student should have: **Sprint board with prioritized tickets, plus a scaffolded Next.js project with database and seed data**.

### Acceptance Criteria
- You can explain today's focus in your own words: Work estimation, ticket writing, sprint planning, and project scaffolding.
- The expected outcome is present and reviewable: Sprint board with prioritized tickets, plus a scaffolded Next.js project with database and seed data.
...
```text
I am stuck on today's focus: Work estimation, ticket writing, sprint planning, and project scaffolding. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
