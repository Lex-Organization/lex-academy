...
### Expected Outcome
By the end of this lesson, the student should have: **Working cart with Context + useReducer, multi-step checkout form, order creation via Server Action, confirmation page**.

### Acceptance Criteria
- You can explain today's focus in your own words: Cart implementation and the complete checkout-to-order flow.
- The expected outcome is present and reviewable: Working cart with Context + useReducer, multi-step checkout form, order creation via Server Action, confirmation page.
...
```text
I am stuck on today's focus: Cart implementation and the complete checkout-to-order flow. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
