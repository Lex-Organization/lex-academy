...
### Expected Outcome
By the end of this lesson, the student should have: **Product class, Cart class, Order class with encapsulated business logic**.

### Acceptance Criteria
- You can explain today's focus in your own words: Object-Oriented JavaScript -- classes, prototypes, inheritance, composition.
- The expected outcome is present and reviewable: Product class, Cart class, Order class with encapsulated business logic.
...
```text
I am stuck on today's focus: Object-Oriented JavaScript -- classes, prototypes, inheritance, composition. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
