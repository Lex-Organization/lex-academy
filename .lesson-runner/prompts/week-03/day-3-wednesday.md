...
### Expected Outcome
By the end of this lesson, the student should have: **Persistent cart (survives page refresh) + robust error handling throughout the store**.

### Acceptance Criteria
- You can explain today's focus in your own words: try/catch/finally, custom errors, localStorage API, JSON persistence, loading states.
- The expected outcome is present and reviewable: Persistent cart (survives page refresh) + robust error handling throughout the store.
...
```text
I am stuck on today's focus: try/catch/finally, custom errors, localStorage API, JSON persistence, loading states. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
