...
### Expected Outcome
By the end of this lesson, the student should have: **Type the store's utility functions (formatPrice, formatDate, validators)**.

### Acceptance Criteria
- You can explain today's focus in your own words: TypeScript project setup, primitive types, type annotations, type inference, typed functions.
- The expected outcome is present and reviewable: Type the store's utility functions (formatPrice, formatDate, validators).
...
```text
I am stuck on today's focus: TypeScript project setup, primitive types, type annotations, type inference, typed functions. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
