...
### Expected Outcome
By the end of this lesson, the student should have: **Product, CartItem, Order, and ProductVariant type definitions for the embroidery store**.

### Acceptance Criteria
- You can explain today's focus in your own words: Interfaces, type aliases, unions, intersections, literal types.
- The expected outcome is present and reviewable: Product, CartItem, Order, and ProductVariant type definitions for the embroidery store.
...
```text
I am stuck on today's focus: Interfaces, type aliases, unions, intersections, literal types. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
