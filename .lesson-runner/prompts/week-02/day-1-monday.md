...
### Expected Outcome
By the end of this lesson, the student should have: **Product catalog rendered on the page from JavaScript data**.

### Acceptance Criteria
- You can explain today's focus in your own words: The DOM tree, selecting elements, creating elements, rendering data dynamically.
- The expected outcome is present and reviewable: Product catalog rendered on the page from JavaScript data.
...
```text
I am stuck on today's focus: The DOM tree, selecting elements, creating elements, rendering data dynamically. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
