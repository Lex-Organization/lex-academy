...
- Actual behavior
- Steps to reproduce
- Error messages, logs, or reproduction notes
- Relevant files
- Recent changes
- Environment details
...
### Expected Outcome
By the end of this lesson, the student should have: **Diagnose and fix one real or seeded bug in the embroidery store using an AI-assisted debugging workflow**.

### Acceptance Criteria
- You can explain today's focus in your own words: Debugging with AI - reproducing issues, gathering evidence, forming hypotheses, and avoiding random patches.
- The expected outcome is present and reviewable: Diagnose and fix one real or seeded bug in the embroidery store using an AI-assisted debugging workflow.
...
```text
I am stuck on today's focus: Debugging with AI - reproducing issues, gathering evidence, forming hypotheses, and avoiding random patches. Ask me one diagnostic question at a time and help me find the smallest next step. Do not solve the whole lesson for me.
```
